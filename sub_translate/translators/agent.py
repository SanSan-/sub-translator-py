...
from sub_translate.utils.translation_utils import postprocess_translation
...
def translate_text(text: str) -> str:
    ...
    global _cache_dirty, _total_input_tokens, _total_output_tokens, _total_cost_usd
    if not text:
        return ""
    ...
    user_prompt = _user_prompt_template.format(source=text)
    try:
